...
atn::SingleCandidate::SingleCandidate(BoardPtr board) : Technique(board) {
  this->find_next_move();
}

void atn::SingleCandidate::find_next_move() {
...
void atn::SingleCandidate::calculate_changes(CellPtr cell) {
...
atn::Value atn::SingleCandidate::calculate_set_value(CellPtr cell) const {
...
atn::MacroCommand atn::SingleCandidate::calculate_aoe_changes(
...
atn::MissingOption::MissingOption(Position pos) noexcept {
  std::stringstream ss;
...
const char* atn::MissingOption::what() const noexcept {
